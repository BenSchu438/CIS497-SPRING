 ...
 * The object pooler for all 3 road objects
 */
...
{
    // this will include mid lane, left lane and right lane
    ...
    // Spawn each lane with its max amount of roads. Space them 4 gaps apart (perfect fit for object size)
